	...
	public static void main(String[] args) {
		...
		if (status == 0) {
			...
			if (income <= brackets[1][0]) {
				...
				tax = brackets[1][0] * rates[0] + (brackets[1][1] - brackets[1][0]) * rates[1]
						+ (income - brackets[1][1]) * rates[2] + (income - brackets[1][3]) * rates[3];
				...
				tax = brackets[1][0] * rates[0] + (brackets[1][1] - brackets[1][0]) * rates[1]
						+ (82250 - brackets[1][1]) * rates[2] + (brackets[1][3] - brackets[1][2]) * rates[3]
			...
			if (income <= brackets[2][0]) {
				...
				tax = brackets[2][0] * rates[0] + (brackets[2][1] - brackets[2][0]) * rates[1]
						...
						+ (income - brackets[2][3]) * rates[4];
			} else {
				tax = brackets[2][0] * rates[0] + (brackets[2][1] - brackets[2][0]) * rates[1]
						+ (brackets[2][2] - brackets[2][1]) * rates[2] + (brackets[2][3] - brackets[2][2]) * rates[3]
						+ (income - brackets[2][3]) * rates[4] + (income - brackets[2][4]) * rates[5];
			}
		} else if (status == 3) {
			if (income <= brackets[3][0]) {
				...
				tax = brackets[3][0] * rates[0] + (income - brackets[3][0]) * rates[1]
						+ (income - brackets[3][1]) * rates[2];
			} else if (income <= brackets[3][3]) {
				tax = brackets[3][0] * rates[0] + (income - brackets[3][0]) * rates[1]
						+ (income - brackets[3][1]) * rates[2] + (income - brackets[3][2]) * rates[3];
			} else if (income <= brackets[3][4]) {
				tax = brackets[3][0] * rates[0] + (income - brackets[3][0]) * rates[1]
						+ (income - brackets[3][1]) * rates[2] + (income - brackets[3][2]) * rates[3]
						+ (income - brackets[3][3]) * rates[4];
			} else {
				tax = brackets[3][0] * rates[0] + (income - brackets[3][0]) * rates[1]
						+ (income - brackets[3][1]) * rates[2] + (income - brackets[3][2]) * rates[3]
						+ (income - brackets[3][3]) * rates[4] + (income - brackets[3][4]) * rates[5];
			}
		} else {
