...
public class Exercise06_15 {
	public static void main(String[] args) {
		...
		for (int i = 50000; i <= 60000; i += 50) {
			System.out.printf("%-7d\t%-6.0f\t%-13.0f\t%-7.0f\t%-7.0f\n", i, computeTax(0, i), computeTax(1, i),
	...
	public static double computeTax(int status, double income) {
		...
		if (status == 0) {
			...
			if (income <= 16700) {
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (income - 67900) * 0.25 + (income - 208850) * 0.28;
			} else if (income <= 372950) {
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28
						+ (income - 208850) * 0.33;
			} else {
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (82250 - 67900) * 0.25 + (208850 - 137050) * 0.28
